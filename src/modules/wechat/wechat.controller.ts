...
import { WechatRegisterByPhoneDto, WeChatRegisterByPhoneSchema } from 'src/validation/wechat';
...
export class WechatController {
  ...
  async registerByPhone(
    @Body(new ZodValidationPipe(WeChatRegisterByPhoneSchema)) body: WechatRegisterByPhoneDto,
